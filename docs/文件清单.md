...
| `workspace/scripts/mail/check_emails.py` | 工作区兼容入口脚本（转发到技能脚本） |
| `workspace/scripts/mail/mark_gmail_read.py` | 工作区兼容入口脚本（转发到技能脚本） |
| `workspace/scripts/mail/mark_qq_read.py` | 工作区兼容入口脚本（转发到技能脚本） |
